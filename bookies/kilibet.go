...
func (b *KiliBet) Name() string { return "kilibet" }
func (b *KiliBet) URL() string  { return b.url }
func (b *KiliBet) SetURL(u string) { b.url = u }

func (b *KiliBet) Verify(doc *goquery.Document) map[string]string {
