...
func (b *BetNare) Name() string { return "betnare" }
func (b *BetNare) URL() string  { return b.url }
func (b *BetNare) SetURL(u string) { b.url = u }

func (b *BetNare) Verify(doc *goquery.Document) map[string]string {
