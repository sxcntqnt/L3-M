...
func (b *BetKing) Name() string { return "betking" }
func (b *BetKing) URL() string  { return b.url }
func (b *BetKing) SetURL(u string) { b.url = u }

func (b *BetKing) Verify(doc *goquery.Document) map[string]string {
