...
func (b *ChezaCash) Name() string { return "chezacash" }
func (b *ChezaCash) URL() string  { return b.url }
func (b *ChezaCash) SetURL(u string) { b.url = u }

func (b *ChezaCash) Verify(doc *goquery.Document) map[string]string {
