...
func (b *StarBet) Name() string { return "starbet" }
func (b *StarBet) URL() string  { return b.url }
func (b *StarBet) SetURL(u string) { b.url = u }

func (b *StarBet) Verify(doc *goquery.Document) map[string]string {
