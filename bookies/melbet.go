...
func (b *MelBet) Name() string { return "melbet" }
func (b *MelBet) URL() string  { return b.url }
func (b *MelBet) SetURL(u string) { b.url = u }

func (b *MelBet) Verify(doc *goquery.Document) map[string]string {
