...
func (b *BetLion) Name() string { return "betlion" }
func (b *BetLion) URL() string  { return b.url }
func (b *BetLion) SetURL(u string) { b.url = u }

func (b *BetLion) Verify(doc *goquery.Document) map[string]string {
