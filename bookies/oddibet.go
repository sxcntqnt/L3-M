...
func (b *OdDiBet) Name() string { return "oddibet" }
func (b *OdDiBet) URL() string  { return b.url }
func (b *OdDiBet) SetURL(u string) { b.url = u }

func (b *OdDiBet) Verify(doc *goquery.Document) map[string]string {
