...
func (b *SokaBet) Name() string { return "sokabet" }
func (b *SokaBet) URL() string  { return b.url }
func (b *SokaBet) SetURL(u string) { b.url = u }

func (b *SokaBet) Verify(doc *goquery.Document) map[string]string {
