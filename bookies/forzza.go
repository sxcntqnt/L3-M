...
func (b *Forzza) Name() string { return "forzza" }
func (b *Forzza) URL() string  { return b.url }
func (b *Forzza) SetURL(u string) { b.url = u }

func (b *Forzza) Verify(doc *goquery.Document) map[string]string {
