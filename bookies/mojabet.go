...
func (b *MojaBet) Name() string { return "mojabet" }
func (b *MojaBet) URL() string  { return b.url }
func (b *MojaBet) SetURL(u string) { b.url = u }

func (b *MojaBet) Verify(doc *goquery.Document) map[string]string {
