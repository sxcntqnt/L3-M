...
func (b *IBet) Name() string { return "ibet" }
func (b *IBet) URL() string  { return b.url }
func (b *IBet) SetURL(u string) { b.url = u }

func (b *IBet) Verify(doc *goquery.Document) map[string]string {
