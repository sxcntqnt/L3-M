...
func (b *BetWay) Name() string { return "betway" }
func (b *BetWay) URL() string  { return b.url }
func (b *BetWay) SetURL(u string) { b.url = u }

func (b *BetWay) Verify(doc *goquery.Document) map[string]string {
